...
class SpriteBank{
 constructor(){this.items={};this.jobs=[];for(const h of E.HEROES)this.load('hero-'+h.id,'art/sprites/hero-'+h.id+'.png',2,2);for(let i=0;i<6;i++)this.load('enemies-'+i,'art/sprites/enemies-'+i+'.png',2,2);this.load('terrain','art/terrain/terrain.png',3,2,false);this.load('props','art/sprites/props.png',3,2);for(const h of E.HEROES)this.load('micro-'+h.id,'art/sprites/micro-'+h.id+'.png',2,2);this.load('micro-enemies','art/sprites/micro-enemies.png',3,2);this.load('micro-terrain','art/terrain/micro-terrain.png',3,1,false);this.load('micro-props','art/sprites/micro-props.png',3,1);this.ready=Promise.allSettled(this.jobs);}
